...
import static com.slim.device.R.styleable.TouchscreenGesture;
import static com.slim.device.R.styleable.TouchscreenGesture_name;
import static com.slim.device.R.styleable.TouchscreenGesture_path;
import static com.slim.device.R.styleable.TouchscreenGesture_scancode;
import static com.slim.device.R.styleable.TouchscreenGesture_defaultAction;
...
public class TouchscreenGestureParser {
    ...
    public static GesturesArray parseGestures(Context context) {
        ...
        try {
            parser = context.getResources().getXml(R.xml.touchscreen_gestures);
